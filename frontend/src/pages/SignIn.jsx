...
const Login = () => {
    return (
        <div className='flex max-h-screen md:h-screen items-center justify-center my-auto'>
            <div className='border border-input md:p-4  p-2  my-20 rounded-xl w-2xs md:w-sm'>
                ...
                <div className=' mx-auto'>
                    ...
                    <div className="input-boxed flex flex-col gap-4">
                        <Input className={'text-sm'} type="text" placeholder='Enter Your Username OR Email Here' />
